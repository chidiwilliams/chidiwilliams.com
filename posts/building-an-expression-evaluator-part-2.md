...
In my [previous post](/posts/building-an-expression-evaluator), we explored how expression evaluation works and built a program, `evaluate`, that returns the result of an arithmetic expression.
